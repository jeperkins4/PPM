...
layout 'administration'
  ...
  def index
    @user_types = UserType.find(:all)

    respond_to do |format|
      format.html # index.rhtml
      format.xml  { render :xml => @user_types.to_xml }
    end
  end
  ...
  def show
    ...
    respond_to do |format|
      ...
      format.xml  { render :xml => @user_type.to_xml }
    end
  end
  ...
  def create
    ...
    respond_to do |format|
      if @user_type.save
        ...
        format.html { redirect_to user_type_url(@user_type) }
        format.xml  { head :created, :location => user_type_url(@user_type) }
      else
        format.html { render :action => "new" }
        format.xml  { render :xml => @user_type.errors.to_xml }
      end
    end
  end
